...
template<> ::mediapipe::GraphRuntimeInfoConfig* Arena::CreateMaybeMessage<::mediapipe::GraphRuntimeInfoConfig>(Arena*);
...
class GraphRuntimeInfoConfig final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mediapipe.GraphRuntimeInfoConfig) */ {
 public:
  inline GraphRuntimeInfoConfig() : GraphRuntimeInfoConfig(nullptr) {}
  ~GraphRuntimeInfoConfig() override;
  explicit constexpr GraphRuntimeInfoConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GraphRuntimeInfoConfig(const GraphRuntimeInfoConfig& from);
  GraphRuntimeInfoConfig(GraphRuntimeInfoConfig&& from) noexcept
  ...
  friend void swap(GraphRuntimeInfoConfig& a, GraphRuntimeInfoConfig& b) {
    a.Swap(&b);
  }
  ...
  GraphRuntimeInfoConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GraphRuntimeInfoConfig>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GraphRuntimeInfoConfig& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const GraphRuntimeInfoConfig& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "mediapipe.GraphRuntimeInfoConfig";
  }
  protected:
  explicit GraphRuntimeInfoConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
...
class CalculatorGraphConfig final :
 ...
 public:
  ...
  void set_allocated_runtime_info(::mediapipe::GraphRuntimeInfoConfig* runtime_info);
  private:
  ...
  void unsafe_arena_set_allocated_runtime_info(
      ::mediapipe::GraphRuntimeInfoConfig* runtime_info);
...
inline bool GraphRuntimeInfoConfig::_internal_enable_graph_runtime_info() const {
  return enable_graph_runtime_info_;
}
...
inline void GraphRuntimeInfoConfig::_internal_set_enable_graph_runtime_info(bool value) {
  ...
  enable_graph_runtime_info_ = value;
}
...
// .mediapipe.GraphRuntimeInfoConfig runtime_info = 22;
inline bool CalculatorGraphConfig::_internal_has_runtime_info() const {
...
inline const ::mediapipe::GraphRuntimeInfoConfig& CalculatorGraphConfig::_internal_runtime_info() const {
  const ::mediapipe::GraphRuntimeInfoConfig* p = runtime_info_;
  return p != nullptr ? *p : reinterpret_cast<const ::mediapipe::GraphRuntimeInfoConfig&>(
      ::mediapipe::_GraphRuntimeInfoConfig_default_instance_);
}
inline const ::mediapipe::GraphRuntimeInfoConfig& CalculatorGraphConfig::runtime_info() const {
  // @@protoc_insertion_point(field_get:mediapipe.CalculatorGraphConfig.runtime_info)
  return _internal_runtime_info();
}
inline void CalculatorGraphConfig::unsafe_arena_set_allocated_runtime_info(
    ::mediapipe::GraphRuntimeInfoConfig* runtime_info) {
  if (GetArenaForAllocation() == nullptr) {
...
inline ::mediapipe::GraphRuntimeInfoConfig* CalculatorGraphConfig::release_runtime_info() {
  ...
  ::mediapipe::GraphRuntimeInfoConfig* temp = runtime_info_;
  runtime_info_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::mediapipe::GraphRuntimeInfoConfig* CalculatorGraphConfig::_internal_mutable_runtime_info() {
  ...
  if (runtime_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::mediapipe::GraphRuntimeInfoConfig>(GetArenaForAllocation());
    runtime_info_ = p;
  }
  return runtime_info_;
}
inline ::mediapipe::GraphRuntimeInfoConfig* CalculatorGraphConfig::mutable_runtime_info() {
...
inline void CalculatorGraphConfig::set_allocated_runtime_info(::mediapipe::GraphRuntimeInfoConfig* runtime_info) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete runtime_info_;
  }
  if (runtime_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::mediapipe::GraphRuntimeInfoConfig>::GetOwningArena(runtime_info);
    if (message_arena != submessage_arena) {
